...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-ExpressRaider_MiSTer.git"
CORE_NAME=(Arcade-ExpressRaider)
...
UPSTREAM_CORE_NAME=(Arcade-ExpressRaider)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-ExpressRaider.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-ExpressRaider.rbf)
